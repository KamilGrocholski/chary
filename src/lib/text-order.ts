 ...
 * newest of a world, which world heads the manifest. A sort that depends on the machine it
 * ran on is a sort that disagrees between a developer's laptop and the deploy runner.
 *
...
export function getTextOrder(left: string, right: string): number {
